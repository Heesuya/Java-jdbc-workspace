...
public class Board {
	...
	public Board(int boardNo, String boardTitle, int readCount, Date writeDate, String boardWriterName) {
		super();
		this.boardNo = boardNo;
		this.boardTitle = boardTitle;
		this.readCount = readCount;
	...
	public String toString() {
		return "Board [boardNo=" + boardNo + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent
				+ ", boardWriter=" + boardWriter + ", readCount=" + readCount + ", writeDate=" + writeDate
